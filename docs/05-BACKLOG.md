...
| THR-E5 | Play Billing ingestion (Android) | 2 | P1 |
...
| THR-S7 | E4 | StoreKit detection | iOS auto-detects active subs/trials and syncs |
| THR-S8 | E5 | Play Billing detection | Android auto-detects active subs/trials and syncs |
